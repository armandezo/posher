...
<html lang="en">
    ...
    <head>
        ...
        <title>Posher &amp; Marketplace</title>
        ...
        <!-- ADD THIS CODE IN ALL THE HEADS-->
        ...
        <script src="toastr/toastr.js" type="text/javascript"></script>
        <!-- END -->
    </head>
    ...
    <body>
        <header class="header header--standard header--market-place-1" data-sticky="true">
            ...
            <div class="header__content">
                <div class="container">
                    <div class="header__content-left">
                        ...
                        </div><a class="ps-logo" href="index.html"><img src="../img/logo.png" alt=""></a>
                    </div>
                    <div class="header__content-center">
                        <form class="ps-form--quick-search" action="index.html" method="get">
                            ...
                            <input class="form-control" type="text" placeholder="Estoy Buscando...">
                            <button style="color: white !important;">Buscar</button>
                        </form>
                    </div>
                    <div class="header__content-right">
                        <div class="header__actions"><a class="header__extra" href="#"><i class="icon-heart"></i><span ><i style="color: white;">0</i></span></a>
                            <div class="ps-cart--mini"><a class="header__extra" href="#"><i class="icon-bag2"></i><span><i style="color: white;">0</i></span></a>
                                <div class="ps-cart__content">
                                    ...
                                    <div class="ps-cart__footer">
                                        ...
                                        <figure><a class="ps-btn" style="color: white !important;" href="shopping-cart.html">View Cart</a><a class="ps-btn" style="color: white !important;" href="checkout.html">Checkout</a></figure>
                                    </div>
                                </div>
                            </div>
                            <div class="ps-block--user-header">
                                ...
                                <div class="ps-block__right">
                                    <a href="#" style="line-height: 50px;">Mi Cuenta</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <nav class="navigation" style="color:#0f15d4">
                <div class="container">
                    <div class="navigation__left">
                        <div class="menu--product-categories">
                            <div class="menu__toggle"><i class="icon-menu"></i><span style="color:#0f15d4"> Categorías</span></div>
                            <div class="menu__content">
                                <ul class="menu--dropdown">
                    ...
                    <div class="navigation__right">
                        <ul class="menu">
                            <li class=""><a href="index.html " style="color:#0f15d4;font-weight: 800;">Inicio</a>

                            </li>
                            <li class="" ><a href="#" style="color:#0f15d4;font-weight: 800">Nosotros</a><span class="sub-toggle"></span>

                            </li>
                            <li class=""><a href="shop-default.html" style="color:#0f15d4;font-weight: 800">Comprar</a><span class="sub-toggle"></span>

                            </li>

                            <li class="menu-item-has-children has-mega-menu"><a href="#" style="color:#0f15d4;font-weight: 800">Blogs</a><span class="sub-toggle"></span>
                                <div class="mega-menu">
                                    <div class="mega-menu__column">
                        ...
                        <div class="ps-block--header-hotline inline">
                            <p style="color:#0f15d4"><i class="icon-telephone" style="color:#0f15d4;font-weight: 800"></i>Hotline:<strong style="color:#0f15d4;font-weight: 800"> 1-800-234-5678</strong></p>
                        </div>
                    </div>
                </div>
            </nav>
            ...
            <div class="navigation--mobile">
                ...
                <div class="navigation__right">
                    <div class="header__actions">
                        ...
                        <div class="ps-block--user-header">
                            <div class="ps-block__left"><i class="icon-user"></i></div>
                            <div class="ps-block__right"><a href="my-account.html" style="color:#0f15d4">Ingreso</a><a href="my-account.html" style="color:#0f15d4">Registro</a></div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="ps-tabs">
                            <div class="ps-tab active" id="sign-in">
                                <div class="ps-form__content">
                                    <h4 class="pb-5">Ingresa en tu cuenta</h4>
                                    ...
                                    <div class="form-group">
                                        <div class="ps-checkbox">
                                            ...
                                            <label for="remember-me">Recordarme Credenciales</label>
                                        </div>
                                    </div>
                                    <div class="form-group submtit">
                                        <button class="ps-btn ps-btn--fullwidth btnlogin" type="button" style="color: white !important;">Iniciar Sesion</button>
                                    </div>
                                </div>
                            ...
                            <div class="ps-tab" id="register">
                                <div class="ps-form__content">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="Nombre Completo" id="nombre" name="nombre" maxlength="50">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="Apellido Completo" id="apellido" name="apellido" maxlength="50">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group submtit">
                                        <button class="ps-btn ps-btn--fullwidth btnregister" style="color: white !important;" type="button">Registrate</button>
                                    </div>
                                </div>
                                <div class="ps-form__footer">
                                    <p>Conectar con:</p>
                        ...
                        <div class="col-xl-7 col-lg-12 col-md-12 col-sm-12 col-12 ">
                            <div class="ps-form__right">
                                <div class="form-group--nest">
                                    ...
                                    <button class="ps-btn" style="color: white !important;">Subscribirse</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <footer class="ps-footer ps-footer--2">
            <div class="container">
                            ...
                            <aside class="widget widget_newletters">
                                ...
                                <form class="ps-form--newletter" action="#" method="get">
                                    <div class="form-group--nest">
                                        ...
                                        <button class="ps-btn" style="color: white !important;">Subscribe</button>
                                    </div>
                                    <ul class="ps-list--social">
                                        <li><a class="facebook" href="#"><i class="fa fa-facebook"></i></a></li>
                                        <li><a class="twitter" href="#"><i class="fa fa-twitter"></i></a></li>
                ...
                <div class="ps-footer__copyright">
                    <p>© 2020 Posher. Todos Derechos Reservados</p>
